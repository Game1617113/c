...
import re # นำเข้า module สำหรับ Regular Expression เพื่อจัดการสตริงตัวเลข
...
def clean_expression_for_eval(expression):
    ...
    เพื่อป้องกันปัญหาการตีความเป็นเลขฐานแปด (Octal) ใน Python 2 หรือปัญหาการคำนวณใน Python 3.
    """
...
def open_notes():
    ...
    if notes_window is None or not notes_window.winfo_exists():
        ...
        # สร้าง Text widget และโหลดเนื้อหาที่บันทึกไว้ชั่วคราว
        notes_text = tk.Text(
            notes_window, 
            wrap=tk.WORD, 
            font=('Arial', 12),
